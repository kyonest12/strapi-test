...
export interface ApiLoginPageLoginPage extends Schema.SingleType {
  ...
  attributes: {
    form: Attribute.DynamicZone<['element.field', 'element.button']>;
    name: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiTodoTodo extends Schema.CollectionType {
  ...
  attributes: {
    info: Attribute.Component<'element.info'>;
...
export interface ApiTodoPageTodoPage extends Schema.CollectionType {
  collectionName: 'todo_pages';
  info: {
    singularName: 'todo-page';
    pluralName: 'todo-pages';
  ...
  attributes: {
    name: Attribute.String;
    field: Attribute.Component<'element.field', true>;
    buttons: Attribute.Component<'element.button', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::todo-page.todo-page',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::todo-page.todo-page': ApiTodoPageTodoPage;
